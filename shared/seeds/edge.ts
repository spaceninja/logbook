...
export const edgeSeed: Item[] = [
  ...
  // ----- DNF (did not finish) -------------------------------------------------
  // Carries a completion date, so it shows in History (2025) with a DNF marker.
  {
    id: 'edge-book-dnf',
    type: 'book',
    title: 'Did Not Finish Book',
    creator: 'Nora Novelist',
    ...img('Did Not Finish Book'),
    release_date: '2021-06-15',
    description: 'Started it, bounced off, logged the date I gave up.',
    length: 520,
    length_unit: 'pages',
    community_rating: 6.4,
    my_rating: 4,
    provider: 'goodreads',
    status: 'dnf',
    is_purchased: true,
    is_prioritized: false,
    completed_dates: ['2025-08-19'],
    completed_years: [2025],
    notes: 'Couldn’t get past the halfway point.',
    tags: ['fantasy'],
    metadata: {},
  },
];
